...
> TODO anàlisi dels boxplots i histogrames
...
> TODO comentar els resultats de la matriu de correlació

# 2.3. Anàlisi explorativa de les dades qualitatives

En primer lloc, volem explorar quins valors prenen les variables quantitatives:
...
Pel que fa a les variables categòriques, n'haurem de fer _one-hot_ encoding; potencialment utilitzant la funció [`one-hot`](https://www.rdocumentation.org/packages/mltools/versions/0.3.5/topics/one_hot) que proporciona R. Seguidament, mostrem amb `barplots` la distribució de cada una de les variables no-numèriques.
